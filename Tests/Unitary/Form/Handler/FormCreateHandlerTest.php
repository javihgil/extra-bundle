...
use Unitary\Form\Handler\helpers\TestFormCreateHandler;

include 'helpers/TestFormCreateHandler.php';

/**
 * Class FormCreateHandlerTest
 */
class FormCreateHandlerTest extends \PHPUnit_Framework_TestCase
{
    /**
